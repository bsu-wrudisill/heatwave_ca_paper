...
%DIF DEL manuscript45af5219937c6f5353fbabf87c32bf6c2410e014.tex   Tue Sep  8 16:35:17 2026
%DIF ADD case_for_temperature.tex                                 Tue Sep  8 16:32:49 2026
...
\title{Solar radiation primarily drives snow ablation during the March 2026 heat wave in the \DIFaddbegin \DIFadd{California }\DIFaddend Sierra Nevada}



\DIFdelbegin %DIFDELCMD < \authors{William Rudisill\affil{1}, Alan Rhoades\affil{1}, Megan Mason\affil{2}, Gabriel Lewis\affil{2}, Andrew Schwartz\affil{2}, Marianne Cowherd\affil{4}, Benjamin Hatchett\affil{3}, Erica Siriila-Woodburn\affil{1}, Dan Feldman\affil{1}}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \authors{William Rudisill\affil{1}, Alan Rhoades\affil{1}, Megan Mason\affil{2}, Gabriel Lewis\affil{2}, Andrew Schwartz\affil{2}, Marianne Cowherd\affil{4}, Benjamin Hatchett\affil{3}, Erica Siirila-Woodburn\affil{1}, Dan Feldman\affil{1}}
\DIFaddend 
...
\begin{keypoints}
\item \DIFdelbegin \DIFdel{Record heat , snow drought, and }\DIFdelend \DIFaddbegin \DIFadd{A record heat wave coincided with record }\DIFaddend rates of snow ablation \DIFdelbegin \DIFdel{occurred }\DIFdelend \DIFaddbegin \DIFadd{during March 2026 }\DIFaddend in the California Sierra Nevada\DIFdelbegin \DIFdel{during March 2026.
}\DIFdelend \DIFaddbegin \DIFadd{. 
}\DIFaddend \item Net-shortwave \DIFaddbegin \DIFadd{radiation, shaped by low snow-albedo and anomalously strong sunshine, }\DIFaddend was the dominant \DIFdelbegin \DIFdel{ablation driver despite the anomalously warm air temperatures.
}%DIFDELCMD < \item %%%
\DIFdel{Low snow-albedo and higher-than-average downwelling shortwave, caused by an anomalous lack of mid-level clouds, contributed to record rates of net-shortwave heating of the snowpack}\DIFdelend \DIFaddbegin \DIFadd{driver of ablation}\DIFaddend .
\item Snow ablated more slowly under vegetation canopy due to enhanced solar shading and reduced heating by turbulent exchange.
\item Less than 1\% of total snow ablation was due to sublimation, lower than the climatological average \DIFaddbegin \DIFadd{for March}\DIFaddend .
\item Boundary-layer decoupling and vapor pressure arguments explain the small contribution of sensible heating and sublimation to the snow energy and mass balance during the heat wave.

\end{keypoints}

\begin{abstract}
\DIFdelbegin \DIFdel{Test
}\DIFdelend \DIFaddbegin \DIFadd{Snow supplies over half of runoff in the western United States. 
It is recognized that solar radiation is the most important ablation forcing, but this poses a paradox: why are ``snow-eater heat waves'' so effective at ablating snow? 
Using the three-sigma heat wave of March 2026 observed at the Central Sierra Snow Laboratory in the California Sierra Nevada (2100 m.a.s.l) as a case study, we ask the following questions: What are the energy balance mechanisms influencing ablation during heat waves? 
Does vegetation canopy enhance or suppress rates of ablation?
Despite high temperatures, the record snow ablation rates remain dominated by solar radiation and snow-albedo feedbacks.
In addition to extreme warmth, March 2026 was also the sunniest in the CERES satellite record (+\mynum{40} }\wmsq \DIFadd{above average).
Additional longwave radiation emitted by canopies (relative to open sky) scales in tandem with increasing air temperature --- but the combined effect alongside solar shading and turbulent exchange yields lower ablation rates under canopy (\mynum{18} mm/day) compared to the open site (\mynum{25} mm/day). 
...
Theoretical arguments show that atmospheric buoyancy effects and vapor pressure gradient limitations explain the limited role of evapo-sublimation from near \mynum{0}}\degrc \DIFadd{snow during heat waves. 
Together, our findings show that forest canopy adds resilience against heat waves in terms of snow ablation rate. 
...
\DIFdelbegin \section*{\DIFdel{Plain Language Summary}}
%DIFAUXCMD
\DIFdel{Enter your Plain Language Summary here or delete this section.}%DIFDELCMD < 
...
Since at least the 1980s, the field of snow hydrology \DIFdelbegin \DIFdel{appreciates }\DIFdelend \DIFaddbegin \DIFadd{has appreciated }\DIFaddend that understanding the climatic behavior of snow necessitates considering the entire energy budget of the snowpack.
...
Both small impurities \cite{Deems2013-vv} and wet and dry grain-growth mechanisms \cite{Colbeck1982-gv} tend to decrease the amount of reflected sunlight (the snow albedo, \albedo) and are responsible, in conjunction with rising sun-angles, for the large increases in springtime \swnet.
...
At the same time, recent work has highlighted the strong correlation between extreme snow ablation (the loss of snow to either sublimation or melt) events and so-called ``snow-eater heat waves'' (SEHW) --- prolonged periods of sustained (day and night), anomalous, and above-freezing \tair during the snow season \cite{Rhoades2026-jm}.
The characteristics of snow-eater heat waves have already appreciably changed since the 1850s\DIFdelbegin \DIFdel{.
These }\DIFdelend \DIFaddbegin \DIFadd{, and these }\DIFaddend events are occurring more frequently, at a higher intensity, over a larger portion of the WUS, and earlier in the water year.

%These with warming in addition to the mean-annual air temperature.
An example of such an early-season, high-intensity, SEHW occurred in March of 2026, when the monthly March \tair across the WUS was 3 standard deviations above long-term averages.
...
This event (which started earlier than the window of occurrence studied in \citeA{Rhoades2026-jm}) resulted in widespread and rapid ablation at many snow-observing sites, and streamflow that was one-to-two months earlier than average in many watersheds \fignop{fig:supp_sagehen_q}{}.
...
\begin{itemize}
  \item What are the dominant ablation energy forcings during Spring heat waves, and how do they scale with increasing \tair?
  \item How do vegetation canopies and atmospheric conditions --- including clouds or lack thereof --- shape such energetic forcings during heat wave events?
...
Approximately half of North America's snow water volume resides under tree canopy \cite{Kim2021-eu}.
Canopies absorb and scatter SW radiation, increase LW radiation, and reduce winds relative to open or non-vegetated snow surfaces; however, the magnitudes of these changes can vary widely across space and time.
Several studies have considered the effects of vegetation and forest management practices on the mean-state of the snow climate of this region\DIFdelbegin \DIFdel{, and it }\DIFdelend \DIFaddbegin \DIFadd{. 
It }\DIFaddend is well observed that snow tends to accumulate more and ablate later in the year in open regions relative to forested regions \cite{Harpold2020-rc, Krogh2020-dh}.
...
However, the interactions between vegetation and discrete extreme heat wave events have not previously been considered.
...
This work is based on in-situ observations collected at the Central Sierra Snow Laboratory (CSSL; \citeA{Schwartz_Cowherd_McGurk_Mason_Riker-Coleman_Zutter_Lewis_2026}) on Donner Pass, CA, described in  Sec. \ref{sec:study_area}.
Geographic controls on snow processes undoubtedly shape heat wave responses --- but modeling these effects adds inherent uncertainties given the difficulty of distributing forcings across complex terrain, which is why we choose to focus on one intensively instrumented and monitored site.
...
To explain energy balance anomalies leading to the March 2026 ablation, we run single-point configurations of the Structure for Unifying Multiple Modeling Alternatives \cite{Clark2015-ni} from 2000-2026 (described in Sec. \ref{sec:models:summa}) for a forested and open site.
Snow energy balance anomalies are interpreted in reference to historical March conditions for each site.
Sec. \ref{sec:snow_seb}--\ref{sec:canopy_influence} reviews the snow energy balance and effects of canopy, and Sec. \ref{sec:methods:radforce} details the methods to quantify the contribution to ablation by radiative processes.



\subsection{Study area}\label{sec:study_area}
We focus our analysis on three basins in the immediate vicinity of the Central Sierra Snow Laboratory (CSSL; 39.32 $^\circ$N, 120.37 $^\circ$W, 2100 m.a.s.l) located in Soda Springs, CA \cite{Schwartz_Cowherd_McGurk_Mason_Riker-Coleman_Zutter_Lewis_2026} in order to understand regional-scale characteristics of the March 2026 snow drought and associated mechanisms.
These include the South Yuba, North Fork American, and Truckee River Watersheds (the greater Truckee River Watershed is composed of the Lake Tahoe basin and Truckee River basin at the eight-digit hydrologic unit code (HUC8) scale) \fig{fig:region_map}{a--d}.
...
% snotel and USHCRN
We use data from twelve Natural Resources Conservation Service (NRCS) SNOwpack TELemetry (SNOTEL) Network stations located throughout the study region spanning 1905 to 2605 m.a.s.l.
...
To supplement SNOTEL temperature records, we use data from four US Historical \DIFdelbegin \DIFdel{Climate Reference Network (USHCRN}\DIFdelend \DIFaddbegin \DIFadd{Climatology Network (USHCN}\DIFaddend ) stations and the gridded nClimGrid \cite{Durre2022-be} throughout the study region.
\DIFdelbegin \DIFdel{USHCRN }\DIFdelend \DIFaddbegin \DIFadd{USHCN }\DIFaddend stations are a high-quality subset \DIFdelbegin \DIFdel{from }\DIFdelend \DIFaddbegin \DIFadd{of }\DIFaddend the larger GHCN-D dataset \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citeA{Menne2012-uu}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{Menne2012-uu}}\hskip0pt%DIFAUXCMD
}\DIFaddend .
The HCNv2 dataset provides homogenized and quality-assured monthly \tair based on \DIFdelbegin \DIFdel{USHCRN }\DIFdelend \DIFaddbegin \DIFadd{USHCN }\DIFaddend data that dates as far back as the late 1800s \cite{Menne2009-ushcn}.
...
To maintain temporally and serially complete records and to compare against climatological March conditions at this site, this work relies primarily on energy balance model estimates from SUMMA, which we validate in detail against all available CSSL energy balance fluxes (Sec. \DIFaddbegin \DIFadd{S}\DIFaddend \ref{supp:sec:validation}).
...
CERES-EBAF provides gold-standard measurements of monthly surface and top-of-atmosphere (TOA) irradiances at a 1x1 $^\circ$ resolution.
...
% summa
The process-based SUMMA model is configured at a point scale to investigate the snow energy balance for open and forested conditions \cite{Clark2015-ni}.
...
We use the Jordan snow layering option, which allows for up to 100 snow layers, the ``UEB-2stream'' approximation for canopy radiation interactions, the ``Louisinv'' option for stability correction of turbulent fluxes, and the ``stickySnow'' canopy snow interception scheme.
...
Daily precipitation from the NRCS SNOTEL site is used directly as forcing when available and in place of ERA5 precipitation rate. 
...
To account for this effect, we compute and apply a \swdn correction coefficient as a function of the solar zenith and azimuth angles to adjust the ERA5 data to account for shadows (see \fignop{fig:supp_fig_SWd_adjust_sza_azm}{}).
...
Additional information about SUMMA validation is provided in the Supplemental Material (Sec. \DIFaddbegin \DIFadd{S}\DIFaddend \ref{supp:sec:validation}).




% RRTMG
% High-level cirrus clouds were observed by the Moderate Resolution Imaging Spectroradiometer (MODIS) satellite imagery at various times during the March 2026 heat wave.
...
% Ozone, water vapor, and thermodynamic profiles for the March 2026 heat wave are acquired from ERA5 for the grid cell encompassing CSSL.
...
% The purpose of this experiment it to provide a theoretical bound on potential cirrus radiative forcing during the heat wave, rather than a quantitative estimate of the integrated cCRE during the event, which would require estimating/retrieving cirrus properties and frequency throughout the duration of the event.
...
where the left-hand side represents changes in the internal state of the snowpack and the \DIFdelbegin \DIFdel{righthand }\DIFdelend \DIFaddbegin \DIFadd{right-hand }\DIFaddend side represents fluxes at the top/bottom of the snow control volume. 
Melt/Refreeze is the rate of Melt or liquid water Refreezing in mass per second multiplied by the latent heat of fusion, $\Delta$CC is the time rate-of-change in the snowpack cold-content \cite{Jennings2018-wz}, $H_s$ and $H_l$ are the turbulent fluxes of sensible and latent heat respectively at the snow/atmosphere interface, \tair is the temperature of the air, \tsnow is the temperature of the snow surface, $\epsilon$ is the emissivity of the snow (0.98), \swdn is the downwelling shortwave radiation, and $\alpha$ is the albedo of the snow surface defined as the ratio of upwelling shortwave radiation (\swup) to \swdn.
...
First, falling snow is intercepted by the canopy and may melt or sublimate from the canopy before reaching the snowpack, so total SWE accumulation under canopy is commonly less than in adjacent open areas \cite{Musselman2008-ws}.
Second, canopy layers have a higher surface roughness than bare-snow and modify turbulent exchanges \cite{Burakowski2018-ch}.
Third, vegetation impacts the radiative balance of the snowpack by altering the \swdn and \lwdn incident on the snow surface.
In SUMMA, the incident \lwdn to the sub-canopy snowpack is \DIFdelbegin \DIFdel{modelled }\DIFdelend \DIFaddbegin \DIFadd{modeled }\DIFaddend by:
...
\end{equation}
where \DIFdelbegin \DIFdel{$\epsilon_c$ }\DIFdelend \DIFaddbegin \DIFadd{$\varepsilon_c$ }\DIFaddend is the emissivity of the canopy layer.
In SUMMA, \DIFdelbegin \DIFdel{the $\epsilon_c$ }\DIFdelend \DIFaddbegin \DIFadd{$\varepsilon_c$ }\DIFaddend is purely a function of the leaf-area index (LAI) and stem-area index.
We turn off vegetation phenology in the model such that \DIFdelbegin \DIFdel{the $\epsilon_c$ }\DIFdelend \DIFaddbegin \DIFadd{$\varepsilon_c$ }\DIFaddend is constant for these experiments.
...
These choices are further validated by comparing \DIFdelbegin \DIFdel{modelled }\DIFdelend \DIFaddbegin \DIFadd{modeled }\DIFaddend sub-canopy \swdn for a range of LAI values against the CSSL radiometers in the forest site, and finding good agreement \fig{fig:supp_sw_validation}{}.
...
\subsection{Ranking SWE, heat wave, and energy balance anomalies}\label{sec:snow_drought}
...
Other deviations from normal conditions are expressed as the \DIFdelbegin \DIFdel{"anomaly," }\DIFdelend \DIFaddbegin \DIFadd{``anomaly,'' }\DIFaddend which is the difference between the current state and the sample mean.
...
% how hot was it
A four-station composite of the long-term and homogenized monthly \DIFdelbegin \DIFdel{USHCRN }\DIFdelend \DIFaddbegin \DIFadd{USHCN }\DIFaddend HCNv2 data shows that 2026 had the highest March \tair observed since the beginning of the record in 1890, and was +3.6 $^\circ$C above the 1981--2010 average --- a full three-$\sigma$ above the mean (z=3) \fig{fig:ushcn_data}{a}.
The nClimGrid likewise shows a +4--6 $^\circ$C anomaly above average in some locations, compared to the +3.6$^\circ$C anomaly observed at the four-station \DIFdelbegin \DIFdel{USHCRN }\DIFdelend \DIFaddbegin \DIFadd{USHCN }\DIFaddend composite \fig{fig:ushcn_data}{b}.

% precip was average, feb storm, feb ros
This prolonged period of heat resulted from an extreme and persistent ridge of high pressure that gained strength throughout March \fig{fig:era5_anoms}{a,b}, with 500 hPa geopotential height anomalies exceeding two standard deviations (\mynum{200} m) throughout March.

% stuff b4 the heat
The region experienced three notable periods of weather immediately prior to the March 2026 heat wave. 
...
Then, between 14--19 February, a total of 100 mm of new SWE accumulated at CSSL, the third-highest four-day total \todo{since records began in 1971; check this.}
...
As the high-pressure ridge grew over the WUS, daily maximum \tair peaked at \DIFdelbegin \DIFdel{20$^{\circ}C$ }\DIFdelend \DIFaddbegin \DIFadd{\mynum{20}}\degrc \DIFaddend on 20 March at CSSL but remained well above normal from 8--31 March, with daily \tair values at the Tahoe City COOP station yielding anomalies of z=2 or greater for four days between the 17th--27th.
SEHW conditions meeting the \citeA{Rhoades2026-jm} criteria were met between \mynum{11} and \mynum{26} March.
SEHW conditions were also met in the latter few days of February following the ROS event.

Correspondingly, the 500 hPa height anomaly exceeded 200 meters across the WUS on 16 March, and was greater than two-$\sigma$ above the detrended mean for that date.
...
SWE ablated at an average rate of \mynum{7.4} mm/day (\mynum{7.1} mm/day) between 1--14 March, after which it accelerated to a rate of \mynum{25.3} mm/day (\mynum{18.7} mm/day) until the end of the month in the open (forest), ablating completely in the open by the \mynum{28th} and the forest site by the \mynum{25th}.
...
A small snowfall event (add mm SWE?) occurred on 2(?) March.
...
% how much swe melted
SWE completely ablated earlier, and at a faster rate than typical for the time period, at SNOTELs throughout the study region \fig{fig:swechange}{a--c}.
The beginning of March saw SWE levels at a \DIFdelbegin \DIFdel{D1 or }\DIFdelend D0 (``abnormally dry'') \DIFdelbegin \DIFdel{level across }\DIFdelend \DIFaddbegin \DIFadd{or D1 (``moderate drought'') level at most of }\DIFaddend the twelve SNOTEL sites \fig{fig:swechange}{d}.
...
By 10 March, 9 of the 12 stations reached 0 mm SWE and the remaining sites were in a D3 (``extreme drought'') drought classification \fig{fig:swechange}{e}.
Only 4 of the SNOTEL sites had a precedent for 0 mm of SWE on 31 March.
Similarly, the snow-covered area reached its lowest ever recorded value on 31 March during the Moderate Resolution Imaging Spectroradiometer (MODIS) record (see Supplemental Material; \DIFdelbegin \DIFdel{\fignop{fig:supp_scachange}}\DIFdelend \DIFaddbegin \DIFadd{\fignop{fig:supp_scachange}{}}\DIFaddend ).
These findings are consistent with the observation that, WUS-wide, 17\% of SNOTELs had the lowest 15 March SWE on record \cite{Marshall2026-sy}.
...
Typically, most SNOTEL sites in this region gain (or remain constant) rather than lose SWE throughout March \DIFdelbegin \DIFdel{\fig{fig:swechange}{b} }\DIFdelend \DIFaddbegin \DIFadd{\fig{fig:swechange}{f} }\DIFaddend with the exception of the two lowest elevation sites.
...
Having examined the geographic and climatic context of March 2026 snow ablation (Sec. \ref{sec:swe_anomalies}) we can begin to investigate the causes of extreme ablation, which are fundamentally governed \DIFdelbegin \DIFdel{be }\DIFdelend \DIFaddbegin \DIFadd{by }\DIFaddend the energy balance of the snow (Eq. \ref{eq:energy_budget}). 
To do so, we now focus on the CSSL site (site ID 428 in \fignop{fig:swechange}{} and also depicted in \fignop{fig:era5_anoms}{c}).
\DIFdelbegin \DIFdel{s. }\DIFdelend We examine time series of energy balance components (Eq. \ref{eq:energy_budget}) \DIFdelbegin \DIFdel{and }\DIFdelend by separating them into nighttime, daytime, and 24-hour averages (\fignop{fig:open_seb}{a--f}, \fignop{fig:forest_seb}{a--f}).

% turb
\hs and \hlat are relatively minor factors compared to radiative fluxes (\fignop{fig:open_seb}{a,b}, \fignop{fig:forest_seb}{a,b}).
Two periods of significant sublimation occurred (negative \hlat) from 5--7 March, which correspond with relatively high wind speed \fig{fig:era5_anoms}{c} but prior to the onset of the March SEHW conditions.
...
\swnet far exceeds the \hs maxima in the open site, however (\fignop{fig:open_seb}{c}, \fignop{fig:forest_seb}{c}) and exceeds \mynum{240} \wmsq by the end of the month (with 24 hr averages of approximately \mynum{120} \wmsq).
...
\lwnet in the open site \DIFdelbegin \DIFdel{has a completely different }\DIFdelend \DIFaddbegin \DIFadd{is of the opposite }\DIFaddend sign. 
...
A significant amount of energy is added back to the snowpack during the nighttime by liquid water refreezing (\mynum{-6 to -33} \wmsq) in the open site, and to a lesser extent the forest site (\fignop{fig:open_seb}{e}, \fignop{fig:forest_seb}{e}).
...
The broadband snow \albedo started at a relatively low value leading up to the March heat wave (\mynum{0.6} to \mynum{0.7}) and declines consistently during the month  \fig{fig:radiative_forcing}{a}.
The declines are well-matched by remote sensing and CSSL observations (see Supplemental Material).

% rf albedo
\rfalb increases at the open site as a function of rising sun-angle, \swdn (not shown), and \albedo decline, reaching a value approaching \mynum{60} \wmsq in the open site based on the SUMMA simulation.
While there is only a minor difference between the SUMMA model snow \albedo between the forest and open sites, the \rfalb in the open exceeds \rfalb in the forest site by more than a factor of three by the end of the heat wave due to attenuation of \swdn by the canopy layer \fig{fig:radiative_forcing}{b}.
...
This effect does not exceed the shading effect of the canopy (\rfcanopy$_{,SW}$)\DIFdelbegin \DIFdel{however, even though }\DIFdelend \DIFaddbegin \DIFadd{, however, because }\DIFaddend the canopy attenuates much of the incident sunlight, so \rfcanopy$_{,Net}$ is near-zero and transitions to negative (cooling the snow) during the hottest part of the heat wave when the sun is also the most intense and the \albedo is at its lowest.

% total amounts
Ultimately, the cumulative energy transmitted from the atmosphere to the snow attributed to \rfalb is \mynum{+105.4} and \mynum{+22.3} \mjmtwo for the open and forest site respectively and \rfcanopy is responsible for a \mynum{-5.4} \mjmtwo effect (reducing energy incident on the snowpack).
\rfcirrus is evaluated in Sec. \DIFdelbegin \DIFdel{\ref{sec:climo_comparison}}\DIFdelend \DIFaddbegin \DIFadd{\ref{sec:results_ceres_ebaf}}\DIFaddend .
...
Sums are computed only for times when snow is present on the ground during March 2026 (\mynum{28 days} in the open and \mynum{25 days} in the forest) and the historical period. 
...
The lack of a significant \lwnet anomaly in the open relative to the anomalous \lwdn is in part explained by the compensating effects of outgoing \lwup --- warmer snow radiates more energy \DIFdelbegin \DIFdel{exponentially (\ref{eq:energy_budget}}\DIFdelend \DIFaddbegin \DIFadd{in proportion to the fourth power of its surface temperature (\eqtn{eq:energy_budget}}\DIFaddend ).

% the snow albedo 
The weighted-average snow $\bar{\alpha}$ during March (weighted by the daily \swdn to account for increasing sun-angle with time) is anomalously low compared to historical conditions for the open and forest sites by a full one standard deviation less than the mean value \fignop{fig:monthly_seb_mar}{c,f}. 

% the results 2
The cumulative terms of panels \fignop{fig:monthly_seb_mar}{a,d} sum to the total Melt, with the small exception of the \DIFdelbegin \DIFdel{change in the }\DIFdelend initial snow cold-content (which is by definition zero when there is no snow)\DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{, which }\DIFaddend is not depicted in the figure.
...
The conversion of ice to liquid water via melting, combined with mass loss via sublimation, is equivalent to the total $\Delta$SWE during the event (in addition to the drainage of the initial liquid content of the snowpack).
Only \mynum{3.9} mm cumulatively sublimated from the sub-canopy snow of the forest site compared with \mynum{0.2} mm from the open site --- which are less than 1\% of the $\Delta$SWE.
...
On the other hand, the nighttime cooling rate is actually stronger in the open site compared to historical conditions by \mynum{10\%}.
...
To understand these anomalies, we examine map-views and timeseries of the CERES-EBAF product for the WUS and the Sierra Nevada subset region \DIFdelbegin \DIFdel{\fig{fig:ebaf_anomaly}{a--c}}\DIFdelend \DIFaddbegin \DIFadd{\fig{fig:ebaf_anomaly}{a--d}}\DIFaddend .
March 2026 had the highest \swdn \DIFdelbegin \DIFdel{to the entire 27 year }\DIFdelend \DIFaddbegin \DIFadd{in the entire 27-year }\DIFaddend CERES record and is more than 1.5 standard deviations above average for the subset region.
...
In other words, clouds typically provide about a \mynum{60} \wmsq reduction in \swdn relative to clear skies in March, but only provided a \mynum{20} \wmsq reduction during March of 2026.
Correspondingly, zero precipitation was observed during the entire month \fig{fig:era5_anoms}{c}.
With this in mind, it is even more remarkable that \lwdn was above average for this region despite a clear-atmosphere, since \DIFdelbegin \DIFdel{clouds radiate as a nearly perfect gray-body at their base-temperature }\DIFdelend \DIFaddbegin \DIFadd{optically thick clouds radiate nearly as black bodies at their cloud-base temperature }\DIFaddend \cite{Shupe2004-kl}.

% in terms of energy .0864 * W/m2 * days == MJ/m2 acc.  
% lf = 334 #kj/kg 
% lf_mj = lf / 1000 #MJ/kg = .334 

In terms of energy, the anomalous increase \DIFaddbegin \DIFadd{in }\DIFaddend \swdn due to the lack of optically thick clouds is equivalent to \mynum{93} \mjmtwo integrated over the duration of snow cover in the open during March 2026. 
...
The relatively small contributions of \hlat and \hs despite anomalously high \tair --- exceeding snow's freezing point by 20 \degrc --- can be explained by considering ``offline'' test cases assuming a fixed 0 \degrc melting snow surface.
...
Accounting for buoyant suppression (using the same parameterization implemented in SUMMA; see Sec. S\ref{supp:summa_desc_model_eq}) decreases \hs relative to the neutral assumption, \DIFdelbegin \DIFdel{and }\DIFdelend so much so that a moderate constant \wspd value of \mynum{5} \ms yields \hs that actually \textit{decreases} as a function of increasing \tair above approximately \mynum{4} \degrc.
...
% latent heat
Evaporation and/or sublimation is likewise impacted by snow's 0 \degrc thermodynamic limit --- the vapor pressure of pooling 0\degrc liquid water or ice on top of the snowpack never exceeds 6.11 hPa \DIFaddbegin \DIFadd{(}\DIFaddend to a reasonable approximation\DIFaddbegin \DIFadd{)}\DIFaddend .
Therefore, the vapor pressure of the air must be less than 6.11 hPa for sublimation or evaporation to occur.
For a constant relative humidity (RH) of 20\% (roughly the minimum observed during the March heat wave), \hlat decreases rather than increases as a function of \tair over a 0\degrc snow regardless of \wspd \fig{fig:idealized_sens_heat}{b,d}.
...
% other work 
Some warming experiments have shown increases in sublimation during mid-winter warm spells \cite{Scaff2024-ob}, though others have found modest change or no change \cite{Sexstone2018-rc}.
Results from downscaled \DIFdelbegin \DIFdel{GCM }\DIFdelend \DIFaddbegin \DIFadd{GCMs }\DIFaddend have pointed towards increases in nocturnal sublimation in continental snowpacks \cite{Rudisill2026-de}. 
Observations also show higher sublimation rates occurring later in the snow season \DIFaddbegin \DIFadd{with more available radiative energy }\DIFaddend \cite{Schwat2025-ur}.
This is still consistent with the previous arguments, however, which are made for the specific case of increasing \tair over 0\degrc snow.
\DIFdelbegin \DIFdel{Increased }\DIFdelend \DIFaddbegin \DIFadd{A climatological increase of }\DIFaddend sublimation with warming may be more indicative of the snow itself warming and increasing its vapor pressure (up to the 6.11 hPa limit at 0\degrc).
In other words, snow that climatologically shifts in surface temperature closer to a 0\degrc state may more frequently sublimate into the atmosphere, but discrete heat wave events may cause a decrease in sublimation if the snow is already near its vapor pressure limit.


% arguments against
The previous argument also assumes that Monin-Obukhov theory --- which underpins turbulent exchange in nearly all land surface and climate models --- is applicable.
...
\DIFdelbegin \DIFdel{More work investigating turbulent exchange characteristics }\DIFdelend \DIFaddbegin \DIFadd{Turbulent exchange }\DIFaddend over snow during extreme heat wave conditions \DIFaddbegin \DIFadd{therefore }\DIFaddend merits additional investigation. 
...
Overnight refreezing is actually better correlated with overnight \lwdn than \tair alone (R$^2$ of \mynum{0.41} vs. \mynum{0.13}), even across the above/below freezing \tair threshold, and the same is true for overnight cold-content production (R$^2$ of \DIFdelbegin \DIFdel{\mynum{0.06} vs. \mynum{0.44}}\DIFdelend \DIFaddbegin \DIFadd{\mynum{0.44} vs. \mynum{0.06}}\DIFaddend ). 
...
A full accounting of the geographic pattern of vegetation/heat wave interactions likely requires considering additional processes such as canopy gap effects, shading from adjacent stands, and the full range of canopy types and parameters that are also aspect- and slope-dependent \cite{Broxton2015-wh}.

% lundquist discussion
\citeA{Lundquist2013-uc} presented a meta-analysis of snow climate studies and concluded that regions where climatological \tair \DIFdelbegin \DIFdel{exceed }\DIFdelend \DIFaddbegin \DIFadd{exceeds }\DIFaddend -1 \degrc typically observe earlier melt-out in forested areas, relative to open regions, and attributed the cause to the interactions related to the concepts expressed by our \rfcanopy analysis.
...
\DIFdelbegin \DIFdel{Some observational evidence is already pointing towards enhanced }\DIFdelend \DIFaddbegin \DIFadd{Observational evidence points towards increasing trends in }\DIFaddend \swdn \DIFdelbegin \DIFdel{in continental regions writ-large, including snow climates \mbox{%DIFAUXCMD
\cite{Nyeki2019-ej}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{(so-called surface ``brightening'' trends) in the WUS and other locations \mbox{%DIFAUXCMD
\cite{Long2009-zr, McKinnon2025-va}}\hskip0pt%DIFAUXCMD
}\DIFaddend .
The incidence of sustained anomalies in cloud-free conditions --- which are themselves fundamentally related to atmospheric thermodynamic changes --- merits additional investigation for considering the climate resiliency of under-canopy snowpacks.
...
The relationships are also likely elevation- and aspect-dependent.
In addition, a key limitation of this work is \DIFdelbegin \DIFdel{the parameterization of the effects of }\DIFdelend \DIFaddbegin \DIFadd{that the effect of }\DIFaddend leaf-litter on the \albedo of the snow under canopy \DIFdelbegin \DIFdel{, which is not parameterized }\DIFdelend \DIFaddbegin \DIFadd{is not represented }\DIFaddend in SUMMA.
...
While the February wet-SEHW and rain-on-snow event did \DIFdelbegin \DIFdel{lead to below-average }\DIFdelend \DIFaddbegin \DIFadd{reduce the }\DIFaddend initial cold-content \DIFdelbegin \DIFdel{, reduce }\DIFdelend \DIFaddbegin \DIFadd{below average, lower the }\DIFaddend surface \albedo, and saturate the snow with liquid water, the initial cold content of the snow was not a large factor in explaining the anomalous monthly rate of ablation.
...
But, the rates of overnight development of cold-content did impact the daily rates of Melt and SWE loss, since the overnight cold-content production rate must be overcome the following day before melting can begin \fig{fig:open_seb}{f} and is as much as one-third of the following day's rate of melt.
Additional analysis shows that cold-content production is limited to a thin layer of snow near the surface of the snowpack and that liquid water persists below.
...
Additional sensitivity tests that prescribed various snow initial conditions on 1 March found that the accumulated amount of melt was largely insensitive to initial liquid water or cold-content.
However, deeper snowpacks with more ice-content (and total SWE) were able to retain more liquid water, meaning the change in $\Delta$SWE from March 1 to March 31 was mitigated by as much as \todo{50} mm; in this way, higher antecedent SWE conditions are more resilient to $\Delta$SWE via their ability to retain more liquid water, not just via their increased cold-content.
This effect may explain some of the behavior of the higher elevation, Independence Lake SNOTEL \fig{fig:swechange}{} that had the lowest rate of $\Delta$SWE across the 12 stations and remained in the 
A second sensitivity test that completely removed the initial liquid water from the pack still resulted in complete ablation of the snow by the end of March, but one to two days later \fig{fig:supp_initial_cond_sens}{}.
These tests highlight that snow ablation is fundamentally governed by energy inputs into the snowpack, above all else. 


\subsection{Future directions and connections to \DIFdelbegin \DIFdel{with }\DIFdelend climate change}
...
At the same time, climate models may underestimate monthly high temperature extremes by \mynum{11--12}\% \cite{Duan2025-rl}.
\DIFdelbegin \DIFdel{The causes of extreme }\DIFdelend \DIFaddbegin \DIFadd{Extreme }\DIFaddend rates of snow ablation \DIFdelbegin \DIFdel{from SEHW }\DIFdelend \DIFaddbegin \DIFadd{during SEHW events }\DIFaddend in general, such as those reported \DIFdelbegin \DIFdel{in \mbox{%DIFAUXCMD
\citeA{Rhoades2026-jm}}\hskip0pt%DIFAUXCMD
may occur }\DIFdelend \DIFaddbegin \DIFadd{by \mbox{%DIFAUXCMD
\citeA{Rhoades2026-jm}}\hskip0pt%DIFAUXCMD
, may arise }\DIFaddend for a variety of reasons that are not represented by the March 2026 event.
In their work, a minimum of 3 days with above-freezing and +6 K above-average \tair was used to classify SEHW events.
We find that both the late February ROS event \DIFdelbegin \DIFdel{, }\DIFdelend and the late March dry and warm period \DIFdelbegin \DIFdel{, both qualify as a SEHW }\DIFdelend \DIFaddbegin \DIFadd{qualify as SEHW events }\DIFaddend following those criteria.
...
\citeA{Musselman2017-av} noted that, given the strong dependency on \swnet, \DIFdelbegin \DIFdel{that }\DIFdelend snowmelt rates may decline in a future even warmer world, since snowmelt will occur earlier in the year when the sun is weaker.
One might wonder if this pattern holds true for anomalous and intense heat wave events such as the events of March 2026.
We find that it does. 
The maximum rates of ablation during this event were on the order of \mynum{25.3} mm/day.
Water year 2023, however, was an above-average snowfall year and snow persisted well into July at CSSL --- rates of snow ablation exceeded \mynum{70} mm/day during that time as the sun was close to its peak.

% what to look at in the future
This work suggests that analyzing the covariance between heat waves and sustained \swdn anomalies \fig{fig:ebaf_anomaly}{} is an important feature to explore to understand SEHW impacts.
Rough calculations suggest that as much as a \DIFdelbegin \DIFdel{third to a quarter }\DIFdelend \DIFaddbegin \DIFadd{quarter to a third }\DIFaddend of the anomalous ablation may be tied to the anomalous \swdn during the month of March (\mynum{40} \wmsq higher than average).

% why does snow melt when it is warm?
...
To address this challenge, we started by investigating the anomalously warm March 2026 in the California Sierra Nevada. 
...
Not only was March anomalously warm, but the CERES satellite record (2000 to present) shows it was the sunniest March on record; \swdn was +\mynum{40} \wmsq above average, driven by a near-complete lack of low or mid-level clouds.
With some assumptions, this is enough energy to melt a maximum of \mynum{100} mm of snow (or approximately 25\% of the snowpack at the beginning of March 2026).
...
Likewise, atmospheric buoyancy effects mitigate sensible heating at high \tair and low winds. Consequently, anomalously warm surface air temperatures, by themselves, do not explain the observed ablation rates of snowpack during \DIFdelbegin \DIFdel{heatwaves}\DIFdelend \DIFaddbegin \DIFadd{heat waves}\DIFaddend . 
...
\begin{figure}[htbp]
  ...
  \caption{
  \todo{Label the Tahoe city COOP station}
  ...
  (b) Terrain elevation of the greater CSSL/Lake Tahoe region. 
    Red open diamonds depict the location of NRCS SNOTEL sites, open black circles show the location of the \DIFdelbeginFL \DIFdelFL{three USHCRN }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{four USHCN }\DIFaddendFL stations in the region, and the open magenta square shows the location of CSSL.
  (c) Shows the location of the study area in the context of the WUS, with the boundary of (b) outlined in a red box. 
  (d) Shows an overview aerial image of CSSL open site, with key instruments labeled, including the ECOR (eddy covariance).
  The location of the forest study site (not shown) is located just outside of the frame.
...
\begin{figure}[htbp]
  ...
  \caption{\todo{label this "z" instead of $sigma$?. Remove . after Tair. Make a and b bold.} (a) Composite \tair anomalies from the four HCNv2 dataset stations in the greater Tahoe region study area for the month of March, from 1890 to 2026. Deviations from the 1980--2026 mean are depicted for one, two, and three standard deviation regions (shading).
...
\begin{figure}[htbp]
  ...
  Periods meeting the \DIFdelbeginFL \DIFdelFL{\mbox{%DIFAUXCMD
\cite{Rhoades2026-jm} }\hskip0pt%DIFAUXCMD
}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\mbox{%DIFAUXCMD
\citeA{Rhoades2026-jm} }\hskip0pt%DIFAUXCMD
}\DIFaddendFL SEHW criteria are outlined with a black box. 
...
\begin{figure}[htbp]
  ...
  \caption{\todo{change to Delta SWE} (a--c) A timeseries of SWE at three SNOTEL stations in the study region.
  ...
  (f) The SWE change between Mar 31 and Mar 1 \dswe (mSWE) compared with the historical record.
...
\begin{figure}[htbp]
  ...
  LW and SW components are depicted in (c).
...
\caption{\todo{FIX SMALL BUG IN LW/SW and albedo averaging!!} Accumulated snow energy fluxes (\swnet, \lwnet, \hs, \hlat, G), Melt, radiation forcings,
...
\begin{figure}[htbp]
  ...
  \caption{\todo{Change ) in the labels to .). Also change "N." Sierra to California Sierra or similar} March \swdn (a) and \lwdn (b) anomalies (relative to the March 2000 to present record) from the CERES-EBAF 1x1 degree resolution product.
...
%   \caption{Factors explaining \swnet during the March heat wave at the open CSSL site.
%     (a) Solar insolation (\swdn) during heat wave,
...
\begin{figure}[htbp]
  ...
  \caption{\todo{increase label size} (a) Idealized sensible heat fluxes ($H_s$) into a melting snowpack as a function of \tair for four wind speeds (1, 5, 10, and 15 m s$^{-1}$) at a 12 m height for open-conditions and a snow surface roughness of z$_0$=0.002 m.
...
\begin{figure}[htbp]
  ...
  \caption{The predictive power of overnight average (a) \tair compared against overnight average (b) \DIFdelbeginFL %DIFDELCMD < \lwnet %%%
\DIFdelendFL \DIFaddbeginFL \lwdn \DIFaddendFL for \DIFaddbeginFL \DIFaddFL{overnight }\DIFaddendFL \dcc, \DIFaddbeginFL \DIFaddFL{overnight }\DIFaddendFL refreezing, and \DIFaddbeginFL \DIFaddFL{next-day }\DIFaddendFL total melt\DIFdelbeginFL \DIFdelFL{during the next-day}\DIFdelendFL . 
...
\begin{table}[h]
\centering
\caption{Forest and open-site energy balance terms (\mjmtwo; mm SWE equivalent in parentheses for H$_l$ and Melt) and cold content change (\mjmtwo) for March 2026 compared against the historical climatology (mean $\pm$ std).}
...
\DIFaddbeginFL \label{tab:definitions}
\DIFaddendFL \begin{tabular}{ll}
\DIFaddbeginFL \toprule
\DIFaddendFL Abbreviation & Definition \\
\midrule
...
SNOTEL       & \DIFdelbeginFL \DIFdelFL{SNowpack }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{SNOwpack }\DIFaddendFL TELemetry site \\
\DIFaddbeginFL \DIFaddFL{SEHW         }& \DIFaddFL{Snow-eater heat wave }\\
\DIFaddFL{SUMMA        }& \DIFaddFL{Structure for Unifying Multiple Modeling Alternatives }\\
\DIFaddFL{USHCN        }& \DIFaddFL{US Historical Climatology Network }\\
\DIFaddFL{WUS          }& \DIFaddFL{Western United States }\\
\bottomrule
