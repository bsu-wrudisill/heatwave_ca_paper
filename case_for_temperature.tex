...
\item March 2026 in the central California Sierra Nevada was the warmest on record, exceeding the previous monthly average air temperature record set during the 1934 Dust Bowl. 
\item Net-shortwave radiation---shaped by low antecedent snow-albedo and clear-skies yielding above average downwelling shortwave radiation---was the dominant driver of snow ablation for both forest and open sites. 
\item Sub-canopy snow was more directly temperature sensitive due to longwave effects, but the canopy ultimately inhibited energy exchange to the snow during the heatwave. 
...
The first limiting mechanism of sublimation during heatwaves is the effect of surface layer stability. 
...
First, the vapor pressure of ice or pooling 0\degrc liquid water cannot not exceed 6.11 hPa (while noting that the vapor pressures of ice and liquid water are not exactly equal; \citeA{Huang2018-re}), meaning that the vapor pressure of near-surface air must be less than this amount for evapo-sublimation to occur. 
