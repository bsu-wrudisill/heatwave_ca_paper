...
\title{Solar radiation primarily drives snow ablation during the March 2026 heat wave in the Sierra Nevada}
...
\begin{keypoints}
\item Record heat, snow drought, and rates of snow ablation occurred in the California Sierra Nevada during March 2026.
\item Net-shortwave was the dominant ablation driver despite the anomalously warm air temperatures.
\item Low snow-albedo and higher-than-average downwelling shortwave, caused by an anomalous lack of mid-level clouds, contributed to record rates of net-shortwave heating of the snowpack.
...
\item Less than 1\% of total snow ablation was due to sublimation, lower than the climatological average.
...
The characteristics of snow-eater heat waves have already appreciably changed since the 1850s.
These events are occurring more frequently, at a higher intensity, over a larger portion of the WUS, and earlier in the water year.
...
Several studies have considered the effects of vegetation and forest management practices on the mean-state of the snow climate of this region, and it is well observed that snow tends to accumulate more and ablate later in the year in open regions relative to forested regions \cite{Harpold2020-rc, Krogh2020-dh}.
...
To supplement SNOTEL temperature records, we use data from four US Historical Climate Reference Network (USHCRN) stations and the gridded nClimGrid \cite{Durre2022-be} throughout the study region.
USHCRN stations are a high-quality subset from the larger GHCN-D dataset \citeA{Menne2012-uu}.
...
To maintain temporally and serially complete records and to compare against climatological March conditions at this site, this work relies primarily on energy balance model estimates from SUMMA, which we validate in detail against all available CSSL energy balance fluxes (Sec. \ref{supp:sec:validation}).
...
where the left-hand side represents changes in the internal state of the snowpack and the righthand side represents fluxes at the top/bottom of the snow control volume. 
...
These choices are further validated by comparing modelled sub-canopy \swdn for a range of LAI values against the CSSL radiometers in the forest site, and finding good agreement \fig{fig:supp_sw_validation}{}.
...
% how hot was it
A four-station composite of the long-term and homogenized monthly USHCRN HCNv2 data shows that 2026 had the highest March \tair observed since the beginning of the record in 1890, and was +3.6 $^\circ$C above the 1981--2010 average --- a full three-$\sigma$ above the mean (z=3) \fig{fig:ushcn_data}{a}.
...
As the high-pressure ridge grew over the WUS, daily maximum \tair peaked at 20$^{\circ}C$ on 20 March at CSSL but remained well above normal from 8--31 March, with daily \tair values at the Tahoe City COOP station yielding anomalies of z=2 or greater for four days between the 17th--27th.
...
Typically, most SNOTEL sites in this region gain (or remain constant) rather than lose SWE throughout March \fig{fig:swechange}{b} with the exception of the two lowest elevation sites.
...
Having examined the geographic and climatic context of March 2026 snow ablation (Sec. \ref{sec:swe_anomalies}) we can begin to investigate the causes of extreme ablation, which are fundamentally governed be the energy balance of the snow (Eq. \ref{eq:energy_budget}). 
To do so, we now focus on the CSSL site (site ID 428 in \fignop{fig:swechange}{} and also depicted in \fignop{fig:era5_anoms}{c}).
s. We examine time series of energy balance components (Eq. \ref{eq:energy_budget}) and by separating them into nighttime, daytime, and 24-hour averages (\fignop{fig:open_seb}{a--f}, \fignop{fig:forest_seb}{a--f}).
...
\lwnet in the open site has a completely different sign. 
...
To understand these anomalies, we examine map-views and timeseries of the CERES-EBAF product for the WUS and the Sierra Nevada subset region \fig{fig:ebaf_anomaly}{a--c}.
March 2026 had the highest \swdn to the entire 27 year CERES record and is more than 1.5 standard deviations above average for the subset region.
...
With this in mind, it is even more remarkable that \lwdn was above average for this region despite a clear-atmosphere, since clouds radiate as a nearly perfect gray-body at their base-temperature \cite{Shupe2004-kl}.

% in terms of energy .0864 * W/m2 * days == MJ/m2 acc.  
% lf = 334 #kj/kg 
% lf_mj = lf / 1000 #MJ/kg = .334 

In terms of energy, the anomalous increase \swdn due to the lack of optically thick clouds is equivalent to \mynum{93} \mjmtwo integrated over the duration of snow cover in the open during March 2026. 
...
Results from downscaled GCM have pointed towards increases in nocturnal sublimation in continental snowpacks \cite{Rudisill2026-de}. 
...
More work investigating turbulent exchange characteristics over snow during extreme heat wave conditions merits additional investigation. 
...
Overnight refreezing is actually better correlated with overnight \lwdn than \tair alone (R$^2$ of \mynum{0.41} vs. \mynum{0.13}), even across the above/below freezing \tair threshold, and the same is true for overnight cold-content production (R$^2$ of \mynum{0.06} vs. \mynum{0.44}). 
...
While the February wet-SEHW and rain-on-snow event did lead to below-average initial cold-content, reduce surface \albedo, and saturate the snow with liquid water, the initial cold content of the snow was not a large factor in explaining the anomalous monthly rate of ablation.
...
Likewise, atmospheric buoyancy effects mitigate sensible heating at high \tair and low winds. Consequently, anomalously warm surface air temperatures, by themselves, do not explain the observed ablation rates of snowpack during heatwaves. 
...
\begin{figure}[htbp]
  ...
  (b) Terrain elevation of the greater CSSL/Lake Tahoe region. 
    Red open diamonds depict the location of NRCS SNOTEL sites, open black circles show the location of the three USHCRN stations in the region, and the open magenta square shows the location of CSSL.
...
\begin{figure}[htbp]
  ...
  \caption{The predictive power of overnight average (a) \tair compared against overnight average (b)\lwnet for \dcc, refreezing, and total melt during the next-day. 
