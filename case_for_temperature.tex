...
\begin{keypoints}
\item Record heat coincided with record snow drought and rates of snow ablation during March of 2026.
...
Recent rapid-attribution studies show that peak snow conditions in March 2026 were the lowest observed at 17\% of observing stations across the WUS, and that this anomaly was 4-times more likely due to anthropogenic climate change.
This event (which started earlier than the window of occurrence studied in \citeA{Rhoades2026-jm}) resulted in widespread and rapid ablation at many snow-observing sites, and streamflow that was one-to-two months earlier than average in many watersheds (Fig. \ref{fig:supp_sagehen_q}).
...
Other deviations from normal conditions are expressed simply as the "anomaly" which is simply the difference from the current state minus the sample mean. 
...
Then, between February 14th to 19th, a total of 100 mm of new SWE accumulated at CSSL, the third-highest four-day total \todo{since records began in 1971; check this.}
...
\swnet far exceeds the \hs maxima in the open site, however (\fignop{fig:open_seb}{c}, \fignop{fig:forest_seb}{c}) and excceeds exceeding \mynum{240} \wmsq by the end of the month (with 24hr averages of approximately  \mynum{120} \wmsq).
...
% rf albedo
\rfalb increases at the open site as a function of both rising sun-angle and \swdn (not shown) and \albedo decline, reaching a value approaching 60 \wmsq in the open site based on the SUMMA simulation.
...
Assuming \mynum{60}\% of that energy is reflected and converted to melting, this is equivalent to \mynum{37} \mjmtwo, or \mynum{110} mm of melt assuming that all of this energy is converted to melt (as opposed to sublimation or other terms of the energy balance).
...
The snow does not instantly freeze when the two-meter \tair cools to 0 \degrc, but rather depends on the energy balance of the snow which sheds heat via \lwnet and \hs (if \tair is warmer than the snow layer) and is balanced ground heat flux and by heat-conduction within the snowpack.
...
This, the incidence of sustained anomalies in cloud-free conditions-- which are themselves fundamentally related to atmospheric thermodynamic changes --- merits additional investigation for considering the climate resiliency of under-canopy snowpacks.
...
But, the rates of overnight development of cold-content did impact the daily rates Melt and SWE loss, since the overnight cold-content production rate must be overcome the following day before melting can begin \fig{fig:open_seb}{f} and is as much as one-third of the following day's rate of melt.
...
The maximum rates of ablation during this event were on the order of \mynum{18} mm/day.
Water year 2023, however, was an above average snowfall year and snow persisted well into July at CSSL --- rates of snow ablation exceeded \mynum{70} mm/day during that time as the sun was close to it's peak. 
